...
import { ChevronRight, Shield, Users, Trophy, CheckCircle, Star, Clock, Award } from 'lucide-react';
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 lg:items-center">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-paulina-primary mb-4 leading-tight">
                MATEMATYKA 1 KLASA SZKOŁY PONADPODSTAWOWEJ
              </h1>

              <p className="text-lg sm:text-xl lg:text-2xl text-paulina-text mb-6">
                Kompletny kurs video z <span className="text-paulina-accent font-semibold">CAŁYM MATERIAŁEM</span> pierwszej klasy
              </p>

              <div className="mb-6">
                <div className="flex items-baseline gap-3">
                  <span className="text-4xl font-bold text-paulina-accent">597 zł</span>
                  <span className="text-2xl text-paulina-error line-through">1000 zł</span>
                  <span className="bg-paulina-error text-white px-2 py-1 rounded text-sm font-semibold">-40%</span>
                </div>
              ...
              <div className="flex flex-wrap gap-4 text-sm">
                <div className="flex items-center text-paulina-text-light">
                  <Shield className="w-4 h-4 mr-1.5 text-paulina-success flex-shrink-0" />
                  30-dniowa gwarancja
                </div>
                <div className="flex items-center text-paulina-text-light">
                  <Users className="w-4 h-4 mr-1.5 text-paulina-success flex-shrink-0" />
                  20 000+ kursantów
                </div>
                <div className="flex items-center text-paulina-text-light">
                  <Trophy className="w-4 h-4 mr-1.5 text-paulina-success flex-shrink-0" />
                  Średnia ocena: 4.9/5
                </div>
              </div>
              ...
              <div className="hidden lg:block mt-8 space-y-3">
                {[
                  'Ponad 60 lekcji video z wyjaśnieniem krok po kroku',
                  'Zadania domowe z rozwiązaniami do każdej lekcji',
                  'Ściągi ze wzorami i schematami rozwiązywania zadań',
                  'Poziom podstawowy i rozszerzony w jednym kursie'
                ].map((benefit, index) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, x: -20 }}
            ...
            >
              <div className="relative">
                <img
                  src="https://paulinaodmatematyki.com/wp-content/uploads/2024/08/1-klasa-1.png"
                  alt="Matematyka 1 Klasa Szkoły Ponadpodstawowej"
            ...
            <div className="bg-white rounded-2xl shadow-card p-4 sm:p-6 max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 gap-2 text-left text-sm">
                {[
                  'Ponad 60 lekcji video z wyjaśnieniem krok po kroku',
                  'Zadania domowe z rozwiązaniami do każdej lekcji',
                  'Ściągi ze wzorami i schematami rozwiązywania',
